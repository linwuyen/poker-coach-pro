...
function LearnPage() { return <div className="space-y-6"><StrategyExplorer /><section className="grid gap-4 md:grid-cols-3"><LearningCard title="底池賠率" description="跟注成本、最低勝率與 EV loss。" status="題庫＋解析支援" /><LearningCard title="SPR 決策" description="依底池與有效籌碼理解承諾程度。" status="Mastery 節點" /><LearningCard title="Blocker 組合" description="由組合削減連結到策略頻率與反轉條件。" status="Strategy v2.1" /></section></div>; }
